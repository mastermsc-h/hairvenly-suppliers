...
| 2026-05 | `appointment`-Intent ging durch LLM-Pfad obwohl Antwort deterministisch (Buchungs-Link) ist | Neuer Intent `appointment` mit Template-Response auf `booking_url` aus Config (Treatwell-Widget auf hairvenly.de eingebettet) | `intent-contact.ts` |
